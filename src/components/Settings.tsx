...
import { Save, User, Store, Shield, Bell, CreditCard, MapPin } from 'lucide-react';
        ...
        return (
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                rows={4}
                defaultValue="Welcome to our store! We offer high-quality products with excellent customer service."
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: 'Low stock alerts', description: 'When products are running low on stock' },
                  { label: 'New reviews', description: 'When customers leave reviews on your products' },
                  { label: 'Sales reports', description: 'Weekly and monthly sales summary' }
                ].map((item, index) => (
